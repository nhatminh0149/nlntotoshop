    ...
    <form name="orderForm" ng-submit="submitOrderForm()" novalidate>
        <div class="row">
            <div class="col-lg-6 col-md-6">
                ...
                @if(Session::has('kh_taiKhoan') && Session::has('kh_matKhau'))
                    <div class="form-group">
                        <label for="kh_taiKhoan">Tài khoản:</label>
                        <input type="text" class="form-control" id="kh_taiKhoan" name="kh_taiKhoan" value="{{ Session::get('kh_taiKhoan') }}" readonly>
                    </div>
                    <div class="form-group">
                        <label for="kh_hoTen">Họ tên:</label>
                        <input type="text" class="form-control" id="kh_hoTen" name="kh_hoTen" value="{{ Session::get('kh_hoTen') }}" readonly>
                    </div>
                    <!-- <div class="form-group">
                        <label for="kh_gioiTinh">Giới tính:</label>
                        <input type="text" class="form-control" id="kh_gioiTinh" name="kh_gioiTinh" value="{{ Session::get('kh_gioiTinh') }}" readonly>
                    </div> -->
                    <div class="form-group">
